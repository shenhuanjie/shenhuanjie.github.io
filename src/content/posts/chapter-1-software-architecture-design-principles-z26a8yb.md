...
published: 2024-04-19T10:58:55.000Z
updated: 2024-04-22T11:42:57.000Z
draft: false
description: 开闭原则（Open-Closed Principle，COP）是指一个软件实体（如类、模块和函数）应该对扩展开放，对修改关闭。所谓的关闭，也正是对扩张和修改两个行为的一个原则。它强调的是用抽象构建框架，用实现扩展细节，可以提高软件系统...
tags: []
category: ''
---
