...
published: 2024-01-29T15:48:19.000Z
draft: false
description: 要生成两个颜色之间的平均过渡，我们可以使用线性插值（Linear Interpolation）来计算中间的颜色。线性插值是一种简单的方法，它假设颜色空间是线性的，即颜色之间的变化是均匀的。以下是一个JavaScript函数，它接受两个...
tags:
  - JavaScript
  - 颜色渐变
category: JavaScript
