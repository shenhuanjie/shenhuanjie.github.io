...
published: 2024-11-18T07:28:06.000Z
updated: 2024-11-18T07:31:13.000Z
draft: false
description: 这是一个典型的Elasticsearch集群因为磁盘空间不足而触发的保护机制，导致索引被设置为只读模式（read-only-allow-delete​）。
tags:
  - Elasticsearch
category: ''
---
