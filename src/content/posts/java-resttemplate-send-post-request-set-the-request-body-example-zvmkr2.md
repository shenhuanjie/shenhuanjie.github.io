...
published: 2025-01-15T12:12:06.000Z
updated: 2025-01-15T12:13:43.000Z
draft: false
description: 在 Java 中使用 RestTemplate​ 发送 POST 请求并设置请求体（body）参数，可以按照以下步骤进行。RestTemplate​ 是 Spring 提供的一个用于发送 HTTP 请求的工具类。
tags:
  - Java
  - RestTemplate
  - POST
