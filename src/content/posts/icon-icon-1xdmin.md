---
title: Layui——图标 Icon
published: 2024-02-04T11:57:10.000Z
updated: 2024-02-04T12:14:02.000Z
draft: false
description: 通过对一个内联元素（如 <i​标签）添加基础类 class="layui-icon"​ 来定义一个图标，然后对元素加上图标对应的 font-class​，即可显示出你想要的图标，如上所示。
tags: []
category: ''
---
