---
title: Layui——布局 框体 Layout
published: 2024-02-04T11:14:20.000Z
updated: 2024-02-04T11:16:04.000Z
draft: false
description: '//头部事件 util.event(''lay-header-event'', { menuLeft: function(othis){ // 左侧菜单事件 layer.msg(''展开左侧菜单的操作'', {icon: 0}); }, me...'
tags: []
category: ''
---
...
[layuiAdmin](https://dev.layuion.com/themes/layuiadmin/) 是一套用于开发通用型管理系统的纯静态的 `HTML`​ 网页界面主题，基于开源的 Layui Web 组件库制作而成，没有任何后端程序及数据库存储等服务端代码。开发者使用该网页模板，可省去前端的大量工作，从而更高效地开发 Web 应用系统。
