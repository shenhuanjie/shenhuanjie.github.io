---
title: Vue 与前端工程化
published: 2024-01-22T18:09:00.000Z
draft: false
description: Vue.js 3 组件化，涉及到了 SCF 开发模式。默认情况下，不能直接使用单文件组件来编写组件，因为浏览器不认识 SFC（.vue）文件。因此，我们需要使用 webpack 或者 Vite 构建一个支持 SFC 开发的 Vue.j...
tags:
  - Vue
  - 前端工程化
  - TypeScript
