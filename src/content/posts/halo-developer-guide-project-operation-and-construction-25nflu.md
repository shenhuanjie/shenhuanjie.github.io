...
published: 2024-09-14T08:26:11.000Z
updated: 2024-09-14T08:36:24.000Z
draft: false
description: 指 Halo 所依赖的工作目录，在 Halo 运行的时候会在系统当前用户目录下产生一个 halo-next 的文件夹，绝对路径为 \/halo-next。里面通常包含下列目录或文件：
tags:
  - Halo
  - Git
  - OpenJDK
