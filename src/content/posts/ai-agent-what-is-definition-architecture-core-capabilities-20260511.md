...
published: 2026-05-11T02:00:00.000Z
draft: false
description: AI Agent（人工智能智能体）是一种能够自主感知环境、做出决策并执行行动以完成特定目标的智能系统。与传统程序不同，AI Agent 不依赖预设的固定流程，而是基于大型语言模型（LLM）的推理能力，动态规划行动路径。
tags:
  - AI Agent
  - LLM
  - 人工智能
